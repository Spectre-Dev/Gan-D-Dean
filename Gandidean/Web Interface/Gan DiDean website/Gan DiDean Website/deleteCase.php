...
<html style = "width:100%; height:100%; margin:0; padding:0;">
  ...
  searchBox.addListener('places_changed', function() {
      ...
      downloadUrl("loadMarker.php", function(data) {
        ...
        for (var i = 0; i < markers.length; i++) {
		  ...
		  //Set unique id
            marker.id = uniqueId;
            uniqueId++;
          var html = "<b>Assigned to: </b>" + assign + "<br/><b>Priority Number: </b>"+ marker.id + "<br/><b>Description: </b>" + description + "<br/><b>Location: </b>" + address + "<br/><br/><input type='hidden' name='id' id='id' value="+marker.id+"/><input type='button' value='Delete' onclick='DeleteMarker(" + marker.id + ")'/>";
	...
	function DeleteMarker(id) {
		...
		var url = "deleteMarker.php?id=" + id;
...
window.location.reload(true);
  ...
  <body onload="load(); setTimeout(myFunction, 3000);" style = "width:100%; height:100%; margin:0; padding:0;">
	...
	<a class="navbar-brand" href="welcome.php"><img src = "images/gandideanlogo.png" alt = "Gan Didean" width = "30" height = "30"></a>
      <a class="navmenu-brand" href="#" style = "background: black; color: white;">Gan Dídean - Delete Case</a>
